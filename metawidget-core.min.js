...
}catch(i){if(alert!==undefined){alert(i)}else{throw i}}};return f}var e;var c=metawidget.util.splitPath(h.path);if(a==="entity"){e=metawidget.util.traversePath(h.toInspect,c.names);if(c.names===undefined){h._simpleBindingProcessor.topLevel=true}else{h._simpleBindingProcessor.topLevelWithPath=true}}else{var g=metawidget.util.traversePath(h.toInspect,c.names);if(g!==undefined){e=g[b.name]}else{e=undefined}}var d=this.bindToWidget(f,e,a,b,h);if(d===true||f.getMetawidget!==undefined||f.nestedMetawidgets!==undefined){h._simpleBindingProcessor.bindings=h._simpleBindingProcessor.bindings||[];h._simpleBindingProcessor.bindings[b.name]={widget:f,elementName:a,attributes:b}}return f};metawidget.widgetprocessor.SimpleBindingProcessor.prototype.bindToWidget=function(e,h,j,d,i){var c=(e.tagName==="INPUT"||e.tagName==="SELECT"||e.tagName==="TEXTAREA");if(c===true&&e.hasAttribute("id")){e.setAttribute("name",e.getAttribute("id"))}var f,b;if(d["enum"]!==undefined&&e.tagName==="DIV"){if(d.type==="array"||d.componentType!==undefined){c=true;b=e.childNodes.length;for(f=0;f<b;f++){var a=e.childNodes[f];if(a.tagName==="LABEL"){var g=a.childNodes[0];if(g.tagName==="INPUT"){g.setAttribute("name",e.getAttribute("id"));if(d.type==="array"){g.checked=(h!==undefined&&h.indexOf(g.value)!==-1)}else{if(d.type==="boolean"){g.checked=(h===g.value||g.value===""+h)}else{g.checked=(h===g.value)}}}}}}}if(h!==undefined){if(e.tagName==="OUTPUT"||e.tagName==="TEXTAREA"){if(d.masked===true){e.innerHTML=metawidget.util.fillString("*",h.length)}else{if(d.enumTitles!==undefined){if(d.type==="array"){b=h.length;for(f=0;f<b;f++){if(f===0){e.innerHTML=""}else{e.innerHTML+=", "}e.innerHTML+=metawidget.util.lookupEnumTitle(h[f],d["enum"],d.enumTitles)}}else{e.innerHTML=metawidget.util.lookupEnumTitle(h,d["enum"],d.enumTitles)}}else{if(d.type==="boolean"){if(h===true){e.innerHTML=metawidget.util.getLocalizedString("Yes",i)}else{if(h===false){e.innerHTML=metawidget.util.getLocalizedString("No",i)}else{e.innerHTML=h}}}else{e.innerHTML=h
}}}}else{if(e.tagName==="INPUT"&&e.getAttribute("type")==="checkbox"){e.checked=h}else{if(c===true){e.value=h}}}}return c};metawidget.widgetprocessor.SimpleBindingProcessor.prototype.save=function(k){var l;var a=false;var m=metawidget.util.splitPath(k.path);if(m.names===undefined){l=k.toInspect}else{var e=m.names.slice(0,m.names.length-1);var i=metawidget.util.traversePath(k.toInspect,e);if(k._simpleBindingProcessor.topLevelWithPath===true){l=i}else{var j=m.names[m.names.length-1];l=i[j];if(l===undefined){l={};i[j]=l}}}for(var b in k._simpleBindingProcessor.bindings){var g=k._simpleBindingProcessor.bindings[b];var d=this.getWidgetFromBinding(g,k);if(d.getMetawidget!==undefined){this.save(d.getMetawidget());continue}var h=this.saveFromWidget(g,k);if(a===false&&l[b]!==h){a=true}if(k._simpleBindingProcessor.topLevel===true){k.toInspect=h;return a}l[b]=h}if(k.nestedMetawidgets!==undefined){for(var f=0,c=k.nestedMetawidgets.length;f<c;f++){this.save(k.nestedMetawidgets[f].getMetawidget())}}return a};metawidget.widgetprocessor.SimpleBindingProcessor.prototype.saveFromWidget=function(f,i){var c=this.getWidgetFromBinding(f,i);if(c.getAttribute("type")==="checkbox"){return c.checked}if(f.attributes.type==="number"){var g=parseFloat(c.value);if(isNaN(g)){return undefined}return g}if(f.attributes["enum"]!==undefined&&c.tagName==="DIV"){if(f.attributes.type==="array"||f.attributes.componentType!==undefined){var e=[];for(var d=0,b=c.childNodes.length;d<b;d++){var a=c.childNodes[d];if(a.tagName==="LABEL"){var h=a.childNodes[0];if(h.checked){if(f.attributes.type==="boolean"){return(h.value===true||h.value==="true")}if(f.attributes.type!=="array"){return h.value}e.push(h.value)}}}return e}}if(f.attributes.type==="boolean"){return(c.value===true||c.value==="true")}if(c.value===""||c.value===null){return}return c.value};metawidget.widgetprocessor.SimpleBindingProcessor.prototype.getWidgetFromBinding=function(a){return a.widget};metawidget.widgetprocessor.SimpleBindingProcessor.prototype.reload=function(b,e){for(var a in e._simpleBindingProcessor.bindings){var d=e._simpleBindingProcessor.bindings[a];
var c=this.getWidgetFromBinding(d,e);if(c.getMetawidget!==undefined){this.reload(b,c.getMetawidget());continue}this.bindToWidget(c,b[c.getAttribute("id")],d.elementName,d.attributes,e)}}})();
